from .prompts_raw import (
    ...
    _prompt_rag_query_generation_animation,
    _prompt_rag_query_generation_fix_error
)
from typing import Union, List

# Create placeholder prompts for context learning since they are missing
_prompt_context_learning_scene_plan = """Examples:
{examples}
"""

_prompt_context_learning_vision_storyboard = """Examples:
{examples}
"""

_prompt_context_learning_technical_implementation = """Examples:
{examples}
"""

_prompt_context_learning_animation = """Examples:
{examples}
"""

_prompt_context_learning_code = """Examples:
{examples}
"""
...
def get_prompt_scene_animation(scene_number: int, topic: str, description: str, scene_outline: str, scene_vision_storyboard: str, technical_implementation_plan: str, relevant_plugins: List[str]) -> str:
    prompt = _prompt_scene_animation.format(
        scene_number=scene_number,
        topic=topic,
        description=description,
        scene_outline=scene_outline,
...
def get_prompt_rag_query_generation_animation(storyboard: str, relevant_plugins: str) -> str:
    """For generating RAG queries during storyboard to animation stage"""
    prompt = _prompt_rag_query_generation_animation.format(
        storyboard=storyboard,
        relevant_plugins=relevant_plugins
    )
    return prompt
...
def get_prompt_context_learning_animation(examples: str) -> str:
    prompt = _prompt_context_learning_animation.format(
        examples=examples
    )
    return prompt
