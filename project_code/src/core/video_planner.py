...
from task_generator import (
    ...
    get_prompt_context_learning_animation,
...
class VideoPlanner:
    ...
    Args:
        model (str): The OpenAI model to use for planning tasks (e.g., "openai/gpt-4o")
    ...
    def __init__(self, model="openai/gpt-4o", output_dir="output", print_response=False, use_context_learning=False, context_learning_path="data/context_learning", use_rag=False, session_id=None, chroma_db_path="data/rag/chroma_db", manim_docs_path="data/rag/manim_docs", embedding_model="text-embedding-ada-002", use_langfuse=True):
        ...
        self.animation_narration_examples = self._load_context_examples('scene_animation') if use_context_learning else None
    ...
    def _load_context_examples(self, example_type: str) -> str:
        ...
        file_patterns = {
            ...
            'scene_animation': '*_scene_animation.txt',
            'code': '*.py'
        }
    ...
    def _format_examples(self, example_type: str, examples: List[str]) -> str:
        ...
        templates = {
            ...
            'scene_animation': get_prompt_context_learning_animation,
    ...
    async def _generate_scene_implementation_single(self, topic: str, description: str, scene_outline_i: str, i: int, file_prefix: str, session_id: str, scene_trace_id: str) -> str:
        ...
        vision_storyboard_plan = self.model(
        ...
        technical_implementation_plan = self.model(
        ...
        # =========================================================
        prompt_animation_narration = get_prompt_scene_animation(i, topic, description, scene_outline_i, vision_storyboard_plan, technical_implementation_plan, self.relevant_plugins)
        ...
        if self.rag_integration:
            rag_queries = self.rag_integration._generate_rag_queries_animation(
                storyboard=vision_storyboard_plan,
                scene_trace_id=scene_trace_id,
                topic=topic,
                scene_number=i,
        ...
        animation_narration_plan = self.model(
